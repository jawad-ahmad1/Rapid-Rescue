...
describe('DriverData Component', () => {
  ...
  beforeEach(() => {
    ...
    MockApiService.getDrivers.mockResolvedValue({
      success: true,
      data: mockDrivers
    });
  });
  ...
  test('delete driver functionality works correctly', async () => {
    ...
    MockApiService.deleteDriver.mockResolvedValue({
      success: true,
  ...
  test('handles API errors correctly', async () => {
    // Mock API error
    MockApiService.getDrivers.mockRejectedValue(new Error('Failed to fetch drivers'));
