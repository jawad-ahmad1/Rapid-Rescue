...
describe('ViewDriver Component', () => {
  ...
  beforeEach(() => {
    ...
    MockApiService.getDriverPerformance.mockResolvedValue(mockPerformance);
    MockApiService.getDriverHistory.mockResolvedValue(mockHistory);
  });
  ...
  test('handles API errors correctly', async () => {
    // Mock API error
    MockApiService.getDriver.mockRejectedValue(new Error('Failed to fetch driver details'));
