...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if options['id']:
            ...
            try:
                ...
                self._process_driver(driver, check_only)
        ...
        # Find driver by username
            ...
            try:
                ...
                try:
                    ...
                    if not check_only and self.confirm_delete_user():
                        user.delete()
    ...
    def _process_driver(self, driver, check_only):
    ...
    def confirm_delete(self):
        ...
        self.stdout.write("Are you sure you want to delete this driver? [y/N] ", ending='')
        answer = input().lower()
        return answer in ('y', 'yes')
    
    def confirm_delete_user(self):
        """Ask for confirmation before deleting an orphaned user"""
        self.stdout.write("User has no associated driver. Delete user anyway? [y/N] ", ending='')
        answer = input().lower()
        return answer in ('y', 'yes') 